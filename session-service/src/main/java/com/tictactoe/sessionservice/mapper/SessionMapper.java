...
public interface SessionMapper {
    ...
    @Mapping(target = "createdAt", ignore = true)   // set by Hibernate @CreationTimestamp
    @Mapping(target = "updatedAt", ignore = true)   // set by Hibernate @UpdateTimestamp
     ...
     * (created but not simulated): board is empty since the Game Engine has no game to report.
     */
